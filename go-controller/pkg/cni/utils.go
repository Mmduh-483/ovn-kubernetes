...
func SetPodInfoSmartNic(namespace, podName, pfindex, vfindex string) error {
	...
	pod := &kapi.Pod{ObjectMeta: metav1.ObjectMeta{Namespace: namespace, Name: podName}}
	return kubecli.SetAnnotationsOnPod(pod, map[string]string{"ovn.smartnic.pf": pfindex, "ovn.smartnic.vf": vfindex})
}
